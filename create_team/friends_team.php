    ...
    <div class="inner_profile" style = "display: flex;
        ...
        <nav>
            <ul>
                ...
                <li><a href="friends_team.php" rel="noopener noreferrer" class="active">Players<span class="badge"><?php echo $get_frnd_num;?></span></a></li>
